...
HTW Berlin Web Components aim to meet Web Content Accessibility Guidelines ([WCAG](https://www.w3.org/WAI/standards-guidelines/wcag/)). Additioanlly the [Web Accessibility Guidelines of HTW Berlin](https://corporatedesign.htw-berlin.de/barrierefreiheit/barrierefreie-webseiten/) should be adhered to.
