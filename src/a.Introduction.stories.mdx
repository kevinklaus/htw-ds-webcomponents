...
Organisms are component combinations that offer over more complex funtionality to users. This could be Navigation elments like Menus or other common features. For example [Top Menu](../?path=/story/design-system-organisms-top-menu--extended-standard) and [Chat](../?path=/story/design-system-organisms-chat--chat)

#### Templates 🖥

Templates are the most complex components. They inlcude skeletons of full user interfaces composed of many individual components e.g. an entire [Application Page](../?path=/story/design-system-pages-application-page--application-page).
