...
Appropriate licencing needs to be addressed in this context as the use of the provided HTW Berlin branding and font is limited. Use is only authorised to HTW Berlin's students for internal and public-facing use cases that are associated with their studies at HTW Berlin. The HTW Berlin font was designed by Jürgen Huber and Malte Herok. It can be freely used, but not adapted.
