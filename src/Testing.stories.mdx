...
<htw-berlin-logo size="m" color="orange"></htw-berlin-logo>
...
The componet will auto-update in teh Canvas so that you can **immediately see your changes applied**.
...
Below each component automatic test results can be viewed in the Tab Accessibility.

#### Vision Deficiency Emulation

In the Canvas Tab above each component different Vision Deficiencies can be emulated to test accessibility.
